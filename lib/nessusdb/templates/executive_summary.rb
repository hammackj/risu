...
start_new_page
	...
	table(results, :headers => headers, :border_style => :grid, :column_widths => header_widths,
		:header_color => 'D0D0D0', :row_colors => ['ffffff', 'f0f0f0']) unless results == nil
	...
	table(results, :headers => headers, :border_style => :grid, :column_widths => header_widths,
		:header_color => 'D0D0D0', :row_colors => ['ffffff', 'f0f0f0'])
	...
	table(results, :headers => headers, :border_style => :grid, :columns_widths => header_widths,
		:header_color => 'D0D0D0', :row_colors => ['ffffff', 'f0f0f0'])
