...
#				File.delete(@file_name) if File.exist?(@file_name)
			...
			it "should have an MD5 of 4f30a246e405d570b320fa8020092ec8 after creation" do
				if File.exist?(@file_name) == true
					require 'digest/md5'
					Digest::MD5.hexdigest(File.read(@file_name)).should == "4f30a246e405d570b320fa8020092ec8"
				end
			end
		end
	end
